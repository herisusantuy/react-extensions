...
const App = () => {
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", null,
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement("img", { src: 'icon.png', alt: 'icon' })));
};
const root = document.createElement('div');
document.body.appendChild(root);
(0,react_dom__WEBPACK_IMPORTED_MODULE_1__.render)(react__WEBPACK_IMPORTED_MODULE_0___default().createElement(App, null), root);
